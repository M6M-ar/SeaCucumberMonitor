(function (a) {
    var f = new function () {
        function p(h) {
            var a = h.offset(), b = document.compatMode == "CSS1Compat",
        ...
        this.init = function () {
            ...
            for (var f = 0, i = [], m = [], b = 0; b < d.length; b++) for (var j = o(d[b][0][0],
        ...
        this.showPicker = function (h, d, b) {
            ...
            a("#bigHexColorText").unbind("keypress").unbind("keyup").unbind("focus").keypress(function () {
                ...
                if (!(b.length <= 0)) {
                    ...
                    if (d < 0) b = b.substring(0, 7); else if (d > 0) for (var e = 0; e < d; e++) b += "0";
                    a("#bigBgshowDiv").css("backgroundColor", b)
                }
            }).keyup(function () {
                var b = a.trim(a(this).val());
            ...
            if (d == "L") a("#bigSections").unbind("mousemove").unbind("mouseout").unbind("click").removeClass("bigpicker-bgimage"),
                u(); else {
                (new Image).src = "./image/big_bgcolor.jpg";
